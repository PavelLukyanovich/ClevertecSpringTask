...
class TagServiceImplTest {
    ...
    public void whenGetTagById_thanReturnCorrectTagDto() {
        Integer id = 1;
        Tag tag = new Tag();
        when(tagRepository.getById(Long.valueOf(id))).thenReturn(tag);
...
/*    @Test
    public void whenUpdateTag_thanReturn1() {
        ...
        when(tagRepository.save(Long.valueOf(id), request)).thenReturn(1L);
        Tag result = tagService.updateTag(Long.valueOf(id), request);
